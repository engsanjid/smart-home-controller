...
**Smart Home Device Controller** is a **Java console-based OOP project** that simulates controlling home devices such as Lights, Fans, ACs, and Doors.
The user can turn devices ON/OFF, check their status, and manage multiple devices from a single menu system.
...
2. Make sure all `.java` files are under the correct package path.
3. Run the file: `SmartHome.java`.
